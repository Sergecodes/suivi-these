    ...
    <div>
      <div className="container">
        <div className="row">
          ...
          <br></br>
          <p>
            1- D'avoir pris contact avec un directeur de thèse et d'avoir obtenu
            son accord pour vous encadrer ET<br></br>
            2- D'avoir obtenu l'accord de l'école doctorale.<br></br>
            Sans ces accords, vous ne pouvez pas faire de demande d'inscription
            en doctorat. <br></br>
            Une fois ces accords obtenus, la procédure de demande d'inscription
            s'effectue en ligne.
          </p>
          <p>
            <button className="btn inscription-btn">INSCRIVEZ VOUS ICI</button>{" "}
          ...
          <p>
            ...
            <br></br>
            Vous devrez ensuite finaliser votre inscription à l'UPS. Pour toutes
            les infos concernant votre inscription à l'Université, vous
          ...
          <div className="container dedans">
            <ul>
              ...
              <li>
                Participer à l'élaboration du réseau des doctorants et docteurs
