...
const AdminSidenav = () => {
  ...
  return (
    <Sidenav  acteur="ADMIN" nom={JuryData.nom} prenom={JuryData.prenom} display={display}>
        <SidenavTitle titre="Serge">
            <SidenavItem>
                <Link to="/acteur/admin/dashboard"><MdDashboard className="me-2"/> DASHBOARD</Link>
            </SidenavItem>
            <SidenavItem>
                <Link to="/acteur/admin/notation"><BsFillFileEarmarkSpreadsheetFill className="me-2"/> NOTATION ETUDIANT</Link>
            </SidenavItem>
        </SidenavTitle>
        <SidenavTitle titre="loic">
            <SidenavItem>
                <Link to="/acteur/admin/profil"><BsPersonFill className="me-2"/> EDITER PROFIL</Link>
            </SidenavItem>
            <SidenavItem>
                <Link to="/acteur/admin/notifications"><BsBellFill className="me-2"/> NOTIFICATIONS</Link>
            </SidenavItem>
        </SidenavTitle>
