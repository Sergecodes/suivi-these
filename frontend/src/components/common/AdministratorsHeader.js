  ...
  return (
    <section className="adminHeader py-2 d-flex  justify-content-around align-items-center row">
      ...
      >
        ...
        <p className=" fw-light text-center welcomeName" style={{ margin: "0px", fontSize:"3vw" }}>
      ...
      <div className="mobile col-1 d-flex d-md-none " onClick={()=>setHamburgerClicked(!hamburgerClicked)}>
     ...
     {/*onClick options*/}
      ...
      <div
        className="profileOptions"
        style={hamburgerClicked === false ||width >=769 ? { display: "none" } : {}}
      >
